...
function useSubject(subject) {
    const [value, setValue] = require$$0.useState(subject.value);
    require$$0.useEffect(() => {
        const unsubscribe = subject.subscribe(setValue);
        return unsubscribe;
    }, [subject]);
    const updateValue = require$$0.useCallback((newValue) => {
...
function useRx(rx) {
    const [value, setValue] = require$$0.useState(rx.value);
    require$$0.useEffect(() => {
...
const SimpleCounter = () => {
    ...
    return (jsxRuntimeExports.jsxs("div", { style: { padding: '20px', textAlign: 'center' }, children: [jsxRuntimeExports.jsxs("h2", { children: ["Simple Counter: ", count] }), jsxRuntimeExports.jsxs("div", { style: { marginTop: '10px' }, children: [jsxRuntimeExports.jsx("button", { onClick: () => controller.increment(), style: { marginRight: '10px', padding: '8px 16px' }, children: "+" }), jsxRuntimeExports.jsx("button", { onClick: () => controller.decrement(), style: { marginRight: '10px', padding: '8px 16px' }, children: "-" }), jsxRuntimeExports.jsx("button", { onClick: () => controller.reset(), style: { padding: '8px 16px' }, children: "Reset" })] })] }));
};

const SimpleHomePage = () => {
    // Setup controller langsung
    const homeController = require$$0.useMemo(() => new HomeController(), []);
...
const FenixPermanentDemo = () => {
    ...
    const homeController = require$$0.useMemo(() => new HomeController(), []);
    const userController = require$$0.useMemo(() => new UserController(), []);
    const appController = require$$0.useMemo(() => new AppController(), []);
    const settingsController = require$$0.useMemo(() => new SettingsController(), []);
    // Use controllers
...
const AdvancedDemo = () => {
    const controller = require$$0.useMemo(() => new AdvancedController(), []);
...
exports.AdvancedDemo = AdvancedDemo;
...
exports.SimpleHomePage = SimpleHomePage;
exports.Subject = Subject;
exports.UserController = UserController;
exports.flox = flox;
exports.rx = rx;
exports.rxBool = rxBool;
exports.rxInt = rxInt;
exports.rxString = rxString;
exports.useBinding = useBinding;
exports.useController = useController;
exports.useControllerSubject = useControllerSubject;
exports.useGlobalController = useGlobalController;
exports.useRx = useRx;
